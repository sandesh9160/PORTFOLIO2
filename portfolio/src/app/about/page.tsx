              ...
              <div className="space-y-12">
                ...
                >
                  ...
                  <Card className="flex-1 hover:shadow-xl transition-all duration-300 border-l-4 border-l-blue-500">
                    <CardHeader className="pb-3">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <CardTitle className="text-xl text-white">Bachelor of Science (B.Sc in MPCS)</CardTitle>
                        <Badge variant="outline" className="w-fit border-blue-500 text-white">CGPA: 7.96</Badge>
                      </div>
                      <CardDescription className="text-base font-medium text-foreground">
                ...
                >
                  ...
                  <Card className="flex-1 hover:shadow-xl transition-all duration-300 border-l-4 border-l-green-500">
                    <CardHeader className="pb-3">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <CardTitle className="text-xl text-white">Intermediate (XII)</CardTitle>
                        <Badge variant="outline" className="w-fit border-green-500 text-white">Percentage: 82.3%</Badge>
                      </div>
                      <CardDescription className="text-base font-medium text-foreground">
                ...
                >
                  ...
                  <Card className="flex-1 hover:shadow-xl transition-all duration-300 border-l-4 border-l-orange-500">
                    <CardHeader className="pb-3">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <CardTitle className="text-xl text-white">Secondary School Certificate (SSC)</CardTitle>
                        <Badge variant="outline" className="w-fit border-orange-500 text-white">CGPA: 7.2</Badge>
                      </div>
                      <CardDescription className="text-base font-medium text-foreground">
