...
export default function About() {
  ...
  <CardContent className="space-y-6">
    <p className="text-lg text-foreground leading-relaxed">
      I’m Sandesh Kenchugundi, a Full Stack Developer Intern at Techsprout AI Labs,
      a product-based, AI-driven startup. I work with Python, Django, JavaScript,
      Bootstrap, and Next.js, focusing on backend development, database design,
      and building responsive, user-friendly web applications.
    </p>

    <p className="text-lg text-foreground leading-relaxed">
      I’m gaining hands-on experience in developing scalable web solutions,
      working with REST APIs, and understanding real-world product workflows.
      I also have exposure to cloud deployment and modern development practices
      used in fast-paced startup environments.
    </p>

    <p className="text-lg text-foreground leading-relaxed">
      I’m passionate about writing clean, maintainable code and continuously
      learning new technologies. My goal is to grow as a software developer and
      contribute to meaningful, impactful products.
    </p>
  </CardContent>
</Card>
          </motion.div>
              ...
              <div className="space-y-12">
                ...
                >
                  ...
                  <Card className="flex-1 hover:shadow-xl transition-all duration-300 border-l-4 border-l-blue-500">
                    <CardHeader className="pb-3">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <CardTitle className="text-xl text-foreground">Bachelor of Science (B.Sc in MPCS)</CardTitle>
                        <Badge variant="outline" className="w-fit border-blue-500 text-foreground">CGPA: 7.96</Badge>
                      </div>
                      <CardDescription className="text-base font-medium text-foreground">
                ...
                >
                  ...
                  <Card className="flex-1 hover:shadow-xl transition-all duration-300 border-l-4 border-l-green-500">
                    <CardHeader className="pb-3">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <CardTitle className="text-xl text-foreground">Intermediate (XII)</CardTitle>
                        <Badge variant="outline" className="w-fit border-green-500 text-foreground">Percentage: 82.3%</Badge>
                      </div>
                      <CardDescription className="text-base font-medium text-foreground">
                ...
                >
                  ...
                  <Card className="flex-1 hover:shadow-xl transition-all duration-300 border-l-4 border-l-orange-500">
                    <CardHeader className="pb-3">
                      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                        <CardTitle className="text-xl text-foreground">Secondary School Certificate (SSC)</CardTitle>
                        <Badge variant="outline" className="w-fit border-orange-500 text-foreground">CGPA: 7.2</Badge>
                      </div>
                      <CardDescription className="text-base font-medium text-foreground">
                  ...
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-12 h-12 bg-blue-500/10 dark:bg-blue-900/20 rounded-full flex items-center justify-center">
                        <div className="text-foreground font-bold">SQL</div>
                      </div>
                      <div>
                  ...
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-12 h-12 bg-yellow-500/10 dark:bg-yellow-900/20 rounded-full flex items-center justify-center">
                        <div className="text-foreground font-bold">Py</div>
                      </div>
                      <div>
                  ...
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-2">
                      <div className="w-12 h-12 bg-purple-500/10 dark:bg-purple-900/20 rounded-full flex items-center justify-center">
                        <div className="text-foreground font-bold">FS</div>
                      </div>
                      <div>
